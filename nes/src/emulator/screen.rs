...
impl<'a> Screen<'a> {
    pub fn new<T>(tc: &'a sdl2::render::TextureCreator<T>, w: u32, h: u32) -> Result<Self,sdl2::render::TextureValueError> {
        let txt = tc.create_texture_streaming(sdl2::pixels::PixelFormatEnum::RGB24, super::GAME_WIDTH, super::GAME_HEIGHT)?;
