...
impl NametableViewer {
    pub fn update(&mut self, nes: &super::super::Nes) {
        let mut txt = self.tc.create_texture_streaming(sdl2::pixels::PixelFormatEnum::RGB24, 512, 480).unwrap();
        ...
        self.canvas.copy(&txt, None, sdl2::rect::Rect::new(0,0,512,480)).unwrap();
        self.canvas.present();
    }
